...
const USERS = [
  { chat_id: 591179640,  username: 'StasSmilnitskiy', last_name: 'Смільницький', first_name: 'Станіслав', middle_name: 'Степанович', position: 'Керівник магазину', phone: '380668809692', shop_code: '12', role: 'employee' as const },
  { chat_id: 650818212,  username: '',                last_name: 'Ромась',        first_name: 'Зінаїда',   middle_name: 'Миколаївна', position: 'Охорона',           phone: '380997664713', shop_code: '1',  role: 'security' as const },
  { chat_id: 6188469320, username: '',                last_name: 'Денисюк',       first_name: 'Анна',      middle_name: 'Сергіївна',  position: 'Керівник магазину', phone: '380672999437', shop_code: '31', role: 'employee' as const },
  { chat_id: 1308180163, username: 'valeraserbin',    last_name: 'Сербін',        first_name: 'Валерій',   middle_name: 'Григорович', position: 'Охорона',           phone: '380685877691', shop_code: '9',  role: 'security' as const },
  { chat_id: 842967370,  username: 'Yaroslavhh',      last_name: 'Чеховський',    first_name: 'Ярослав',   middle_name: 'Вікторович', position: 'Охорона',           phone: '932715330',    shop_code: '9',  role: 'security' as const },
  { chat_id: 5523705095, username: '',                last_name: 'Бойчук',        first_name: 'Віктор',    middle_name: 'Ігорович',   position: 'Охорона',           phone: '80630229801',  shop_code: '9',  role: 'security' as const },
  { chat_id: 5240828056, username: '',                last_name: 'Гудкова',       first_name: 'Оксана',    middle_name: 'Вікторівна', position: 'Охорона',           phone: '995563441',    shop_code: '9',  role: 'security' as const },
  { chat_id: 5091287990, username: 'Alex_Bee_Ready',  last_name: 'Редченко',      first_name: 'Олександр', middle_name: 'Анатолійович',position: 'Охорона',          phone: '380672454784', shop_code: '9',  role: 'security' as const },
  { chat_id: 914929556,  username: 'Vitalik123123',   last_name: 'Антонов',       first_name: 'Віталій',   middle_name: 'Вікторович', position: 'Охорона',           phone: '380680950070', shop_code: '9',  role: 'security' as const },
  { chat_id: 830745489,  username: 'natacrystal12',   last_name: 'Гончарова',     first_name: 'Наталія',   middle_name: 'Василівна',  position: 'Охорона',           phone: '954842516',    shop_code: '37', role: 'security' as const },
];
...
export function seedStores(): void {
  ...
  `);
  for (const s of STORES) upsert.run([s.name, s.code, s.address]);
  logger.info({ count: STORES.length }, 'Stores seeded');
}
...
export function seedUsers(): void {
  ...
  const stores: any[] = db.prepare('SELECT id, code FROM stores').all([]);
  ...
  for (const u of USERS) {
    ...
    const existing: any = db.prepare(
      'SELECT id, telegram_chat_id FROM users WHERE phone = ? OR telegram_chat_id = ?',
    ).get([u.phone, u.chat_id]);
